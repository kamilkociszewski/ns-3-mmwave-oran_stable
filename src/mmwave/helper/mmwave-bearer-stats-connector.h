...
private:
  ...
  std::vector< Ptr<MmWaveBearerStatsCalculator> > m_e2PdcpStatsVector; //!< Calculator for PDCP Statistics
  std::vector< Ptr<MmWaveBearerStatsCalculator> > m_e2RlcStatsVector; //!< Calculator for PDCP Statistics
