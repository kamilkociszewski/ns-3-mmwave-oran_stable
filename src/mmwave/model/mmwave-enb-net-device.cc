  ...
  return ueImsiComplete;
        ...
        MmWaveEnbNetDevice::BuildRicIndicationMessageCuUp(std::string plmId) {
            ...
            for (auto ue: ueMap) {
                ...
                NS_LOG_DEBUG(
                        Simulator::Now().GetSeconds() << " " << m_cellId << " cell, connected UE with IMSI " << imsi
        ...
        MmWaveEnbNetDevice::BuildRicIndicationMessageDu(std::string plmId, uint16_t nrCellId) {
            ...
            for (auto ue: ueMap) {
                ...
                double drbThrDlPdcpBasedUeid =
                        m_drbThrDlPdcpBasedComputationUeid.find(imsi) != m_drbThrDlPdcpBasedComputationUeid.end()
                        ? m_drbThrDlPdcpBasedComputationUeid.at(imsi) : 0;
            ...
            NS_LOG_DEBUG(
                    Simulator::Now().GetSeconds() << " " << m_cellId << " cell, connected UEs number " << ueMap.size()
