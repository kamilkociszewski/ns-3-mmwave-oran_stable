...
#ifndef MMWAVE_MAC_CSCHED_SAP_H
#define MMWAVE_MAC_CSCHED_SAP_H
 ...
 * in the SampleMmWaveMacCschedSapProvider and SampleFfMacCschedSapuser classes
 */
...
class MmWaveMacCschedSapUser
{
public:
  virtual ~MmWaveMacCschedSapUser ();
