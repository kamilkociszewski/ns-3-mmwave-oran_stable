 ...
 *
 */
#ifndef SRC_MMWAVE_EESM_IR_T2_H
#define SRC_MMWAVE_EESM_IR_T2_H
...
public:
  ...
  /**
   * \brief MmWaveEesmIrT2 constructor
   */
  MmWaveEesmIrT2 ();
  /**
   * \brief ~MmWaveEesmIrT2 deconstructor
   */
  virtual ~MmWaveEesmIrT2 ();
