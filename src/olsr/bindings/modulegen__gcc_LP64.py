...
def register_types(module):
    ...
    module.add_class('CallbackImpl', import_from_module='ns.core', parent=root_module['ns3::CallbackImplBase'], template_parameters=['void', 'const ns3::olsr::PacketHeader &', 'const std::vector<ns3::olsr::MessageHeader, std::allocator<ns3::olsr::MessageHeader> > &', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty', 'ns3::empty'])
    ...
    module.add_container('std::vector< ns3::olsr::MessageHeader >', 'ns3::olsr::MessageHeader', container_type='vector')
...
def register_types_ns3_olsr(module):
    ...
    typehandlers.add_type_alias('void ( * ) ( ns3::olsr::PacketHeader const &, ns3::olsr::MessageList const & )', 'ns3::olsr::RoutingProtocol::PacketTxRxTracedCallback')
    typehandlers.add_type_alias('void ( * ) ( ns3::olsr::PacketHeader const &, ns3::olsr::MessageList const & )*', 'ns3::olsr::RoutingProtocol::PacketTxRxTracedCallback*')
    typehandlers.add_type_alias('void ( * ) ( ns3::olsr::PacketHeader const &, ns3::olsr::MessageList const & )&', 'ns3::olsr::RoutingProtocol::PacketTxRxTracedCallback&')
    typehandlers.add_type_alias('void ( * ) ( uint32_t )', 'ns3::olsr::RoutingProtocol::TableChangeTracedCallback')
    typehandlers.add_type_alias('void ( * ) ( uint32_t )*', 'ns3::olsr::RoutingProtocol::TableChangeTracedCallback*')
    typehandlers.add_type_alias('void ( * ) ( uint32_t )&', 'ns3::olsr::RoutingProtocol::TableChangeTracedCallback&')
    ...
    typehandlers.add_type_alias('std::vector< ns3::olsr::MessageHeader >', 'ns3::olsr::MessageList')
    typehandlers.add_type_alias('std::vector< ns3::olsr::MessageHeader >*', 'ns3::olsr::MessageList*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::MessageHeader >&', 'ns3::olsr::MessageList&')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address >', 'ns3::olsr::MprSet')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address >*', 'ns3::olsr::MprSet*')
    typehandlers.add_type_alias('std::set< ns3::Ipv4Address >&', 'ns3::olsr::MprSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::MprSelectorTuple >', 'ns3::olsr::MprSelectorSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::MprSelectorTuple >*', 'ns3::olsr::MprSelectorSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::MprSelectorTuple >&', 'ns3::olsr::MprSelectorSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::LinkTuple >', 'ns3::olsr::LinkSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::LinkTuple >*', 'ns3::olsr::LinkSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::LinkTuple >&', 'ns3::olsr::LinkSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::NeighborTuple >', 'ns3::olsr::NeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::NeighborTuple >*', 'ns3::olsr::NeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::NeighborTuple >&', 'ns3::olsr::NeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TwoHopNeighborTuple >', 'ns3::olsr::TwoHopNeighborSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TwoHopNeighborTuple >*', 'ns3::olsr::TwoHopNeighborSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TwoHopNeighborTuple >&', 'ns3::olsr::TwoHopNeighborSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TopologyTuple >', 'ns3::olsr::TopologySet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TopologyTuple >*', 'ns3::olsr::TopologySet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::TopologyTuple >&', 'ns3::olsr::TopologySet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::DuplicateTuple >', 'ns3::olsr::DuplicateSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::DuplicateTuple >*', 'ns3::olsr::DuplicateSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::DuplicateTuple >&', 'ns3::olsr::DuplicateSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::IfaceAssocTuple >', 'ns3::olsr::IfaceAssocSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::IfaceAssocTuple >*', 'ns3::olsr::IfaceAssocSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::IfaceAssocTuple >&', 'ns3::olsr::IfaceAssocSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::AssociationTuple >', 'ns3::olsr::AssociationSet')
    typehandlers.add_type_alias('std::vector< ns3::olsr::AssociationTuple >*', 'ns3::olsr::AssociationSet*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::AssociationTuple >&', 'ns3::olsr::AssociationSet&')
    typehandlers.add_type_alias('std::vector< ns3::olsr::Association >', 'ns3::olsr::Associations')
    typehandlers.add_type_alias('std::vector< ns3::olsr::Association >*', 'ns3::olsr::Associations*')
    typehandlers.add_type_alias('std::vector< ns3::olsr::Association >&', 'ns3::olsr::Associations&')
...
def register_Ns3CallbackImplBase_methods(root_module, cls):
    ...
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['ns3::olsr::PacketHeader const&'], visibility='protected')
    ## callback.h (module 'core'): static std::string ns3::CallbackImplBase::GetCppTypeid() [member function]
    cls.add_method('GetCppTypeid', 
                   'std::string', 
                   [], 
                   is_static=True, template_parameters=['std::vector<ns3::olsr::MessageHeader', ' std::allocator<ns3::olsr::MessageHeader> > const&'], visibility='protected')
    return
...
def register_Ns3OlsrRoutingProtocol_methods(root_module, cls):
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::RoutingProtocol::OLSR_PORT_NUMBER [variable]
    cls.add_static_attribute('OLSR_PORT_NUMBER', 'uint16_t const', is_const=True)
    ...
    cls.add_method('GetRoutingTableEntries', 
                   ...
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::MprSet ns3::olsr::RoutingProtocol::GetMprSet() const [member function]
    cls.add_method('GetMprSet', 
                   'ns3::olsr::MprSet', 
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::MprSelectorSet const & ns3::olsr::RoutingProtocol::GetMprSelectors() const [member function]
    cls.add_method('GetMprSelectors', 
                   'ns3::olsr::MprSelectorSet const &', 
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::NeighborSet const & ns3::olsr::RoutingProtocol::GetNeighbors() const [member function]
    cls.add_method('GetNeighbors', 
                   'ns3::olsr::NeighborSet const &', 
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::TwoHopNeighborSet const & ns3::olsr::RoutingProtocol::GetTwoHopNeighbors() const [member function]
    cls.add_method('GetTwoHopNeighbors', 
                   'ns3::olsr::TwoHopNeighborSet const &', 
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::TopologySet const & ns3::olsr::RoutingProtocol::GetTopologySet() const [member function]
    cls.add_method('GetTopologySet', 
                   'ns3::olsr::TopologySet const &', 
                   [], 
                   is_const=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::olsr::OlsrState const & ns3::olsr::RoutingProtocol::GetOlsrState() const [member function]
    cls.add_method('GetOlsrState', 
                   'ns3::olsr::OlsrState const &', 
                   [], 
                   is_const=True)
    ...
    cls.add_method('SetIpv4', 
                   ...
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::Ptr<ns3::Ipv4> ns3::olsr::RoutingProtocol::GetIpv4() const [member function]
    cls.add_method('GetIpv4', 
                   'ns3::Ptr< ns3::Ipv4 >', 
                   [], 
                   is_const=True, is_virtual=True)
    ...
    cls.add_method('PrintRoutingTable', 
                   ...
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream'), param('ns3::Time::Unit', 'unit', default_value='::ns3::Time::Unit::S')], 
                   is_const=True, is_virtual=True)
    ## olsr-routing-protocol.h (module 'olsr'): ns3::Ipv4Address ns3::olsr::RoutingProtocol::GetMainAddress(ns3::Ipv4Address iface_addr) const [member function]
    cls.add_method('GetMainAddress', 
                   'ns3::Ipv4Address', 
                   [param('ns3::Ipv4Address', 'iface_addr')], 
                   is_const=True)
