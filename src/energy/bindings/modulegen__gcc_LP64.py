...
def register_types(module):
    ...
    typehandlers.add_type_alias('std::vector< ns3::Ptr< ns3::EnergyHarvester > > const_iterator', 'ns3::EnergyHarvesterContainer::Iterator')
    typehandlers.add_type_alias('std::vector< ns3::Ptr< ns3::EnergyHarvester > > const_iterator*', 'ns3::EnergyHarvesterContainer::Iterator*')
    typehandlers.add_type_alias('std::vector< ns3::Ptr< ns3::EnergyHarvester > > const_iterator&', 'ns3::EnergyHarvesterContainer::Iterator&')
...
def register_Ns3EnergyHarvesterHelper_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## energy-harvester-helper.h (module 'energy'): ns3::EnergyHarvesterHelper::EnergyHarvesterHelper(ns3::EnergyHarvesterHelper const & arg0) [constructor]
...
def register_Ns3LiIonEnergySourceHelper_methods(root_module, cls):
    ## li-ion-energy-source-helper.h (module 'energy'): ns3::LiIonEnergySourceHelper::LiIonEnergySourceHelper(ns3::LiIonEnergySourceHelper const & arg0) [constructor]
...
def register_Ns3RvBatteryModelHelper_methods(root_module, cls):
    ## rv-battery-model-helper.h (module 'energy'): ns3::RvBatteryModelHelper::RvBatteryModelHelper(ns3::RvBatteryModelHelper const & arg0) [constructor]
...
def register_Ns3TracedValue__Ns3Time_methods(root_module, cls):
    ...
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::Time>::TracedValue(ns3::TracedValue<ns3::Time> const & other) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::Time > const &', 'other')])
    ## traced-value.h (module 'core'): ns3::TracedValue<ns3::Time>::TracedValue(ns3::TracedValue<ns3::Time> const & other) [constructor]
    cls.add_constructor([param('ns3::TracedValue< ns3::Time > const &', 'other')])
...
def register_Ns3BasicEnergyHarvesterHelper_methods(root_module, cls):
    ## basic-energy-harvester-helper.h (module 'energy'): ns3::BasicEnergyHarvesterHelper::BasicEnergyHarvesterHelper(ns3::BasicEnergyHarvesterHelper const & arg0) [constructor]
...
def register_Ns3BasicEnergySourceHelper_methods(root_module, cls):
    ## basic-energy-source-helper.h (module 'energy'): ns3::BasicEnergySourceHelper::BasicEnergySourceHelper(ns3::BasicEnergySourceHelper const & arg0) [constructor]
...
def register_Ns3EnergyHarvesterContainer_methods(root_module, cls):
    ## energy-harvester-container.h (module 'energy'): ns3::EnergyHarvesterContainer::EnergyHarvesterContainer(ns3::EnergyHarvesterContainer const & arg0) [constructor]
    ...
    ## energy-harvester-container.h (module 'energy'): ns3::EnergyHarvesterContainer::Iterator ns3::EnergyHarvesterContainer::Begin() const [member function]
    cls.add_method('Begin', 
    ...
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## energy-harvester-container.h (module 'energy'): ns3::EnergyHarvesterContainer::Iterator ns3::EnergyHarvesterContainer::End() const [member function]
    cls.add_method('End', 
                   'ns3::EnergyHarvesterContainer::Iterator', 
                   [], 
                   is_const=True)
...
def register_Ns3LiIonEnergySource_methods(root_module, cls):
    ## li-ion-energy-source.h (module 'energy'): ns3::LiIonEnergySource::LiIonEnergySource(ns3::LiIonEnergySource const & arg0) [constructor]
...
def register_Ns3RvBatteryModel_methods(root_module, cls):
    ## rv-battery-model.h (module 'energy'): ns3::RvBatteryModel::RvBatteryModel(ns3::RvBatteryModel const & arg0) [constructor]
...
def register_Ns3BasicEnergyHarvester_methods(root_module, cls):
    ## basic-energy-harvester.h (module 'energy'): ns3::BasicEnergyHarvester::BasicEnergyHarvester(ns3::BasicEnergyHarvester const & arg0) [constructor]
...
def register_Ns3BasicEnergySource_methods(root_module, cls):
    ## basic-energy-source.h (module 'energy'): ns3::BasicEnergySource::BasicEnergySource(ns3::BasicEnergySource const & arg0) [constructor]
